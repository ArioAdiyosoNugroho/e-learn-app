        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                <div class="flex items-center gap-4">
                    <a href="materi.html" class="group p-2 rounded-full hover:bg-slate-100 transition-colors">
                ...
                <div class="flex items-center gap-2">
                    <button class="text-sm font-medium text-slate-500 hover:text-slate-900 px-4 py-2 rounded-lg hover:bg-slate-50 transition-colors">Preview</button>
                    <button class="text-sm font-medium text-red-600 hover:text-red-700 hover:bg-red-50 px-4 py-2 rounded-lg transition-colors">Batal</button>
                </div>
            </div>
        </div>
    </nav>
