                ...
                <div class="lg:col-span-8 space-y-6">
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-slate-200/60 overflow-hidden transition-all duration-300"
                        ...
                        <div class="p-6 md:p-8 space-y-6">
                            ...
                            <!-- Pengaturan File -->
                            <div class="mt-6">
                                <h3 class="text-sm font-medium text-slate-700 mb-4">Pengaturan File</h3>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        <label class="block text-sm font-medium text-slate-700 mb-2">Nama
                                            Tampilan</label>
                                        <input type="text"
                                            class="w-full px-4 py-3 rounded-xl bg-slate-50 border border-slate-200 text-slate-800 placeholder-slate-400 focus:outline-none focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all"
                                            placeholder="Contoh: Modul Aljabar Linear" value="Modul Aljabar Linear">
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-slate-700 mb-2">Urutan
                                            Materi</label>
                                        <div class="relative">
                                            <select
                                                ...
                                                <option>1 - Materi pertama</option>
                                                <option selected>2 - Materi kedua</option>
                                                <option>3 - Materi ketiga</option>
                                                <option>4 - Materi keempat</option>
                                            </select>
                                            <div
                        ...
                        <div class="p-6 md:p-8 space-y-6">
                            ...
                            <div>
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <button type="button"
                                        ...
                                        <i class="fas fa-link mr-2"></i>Validasi
                                    </button>
                                </div>
                            ...
                            <div id="videoPreview" class="hidden">
                                ...
                                <div class="mt-4 p-4 bg-slate-50 rounded-xl border border-slate-200">
                                    <h4 class="font-medium text-slate-800" id="videoTitle">Pengantar Aljabar Linear</h4>
                                    <p class="text-sm text-slate-600 mt-1" id="videoDescription">Video penjelasan
                                        tentang dasar-dasar aljabar linear untuk pemula.</p>
                                    <div class="flex items-center gap-4 mt-3">
                                        <span class="text-xs font-medium text-slate-500">
                                            <i class="far fa-clock mr-1"></i> 15:30
                                        </span>
                                        <span class="text-xs font-medium text-slate-500">
                                            <i class="fas fa-external-link-alt mr-1"></i> YouTube
                                        </span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- Pengaturan Video -->
                            <div class="mt-6">
                                <h3 class="text-sm font-medium text-slate-700 mb-4">Pengaturan Video</h3>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        <label class="block text-sm font-medium text-slate-700 mb-2">Judul Video</label>
                                        <input type="text"
                                            class="w-full px-4 py-3 rounded-xl bg-slate-50 border border-slate-200 text-slate-800 placeholder-slate-400 focus:outline-none focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all"
                                            placeholder="Masukkan judul video" value="Pengantar Aljabar Linear">
                                    </div>
                                    <div>
                                        ...
                                        <input type="text"
                                            class="w-full px-4 py-3 rounded-xl bg-slate-50 border border-slate-200 text-slate-800 placeholder-slate-400 focus:outline-none focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all"
                                            placeholder="Contoh: 15 menit" value="15 menit">
                                    </div>
                                </div>
                                <div class="mt-4">
                                    <label class="block text-sm font-medium text-slate-700 mb-2">Deskripsi Video</label>
                                    <textarea rows="3"
                                        class="w-full px-4 py-3 rounded-xl bg-slate-50 border border-slate-200 text-slate-800 placeholder-slate-400 focus:outline-none focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all resize-none">Video penjelasan tentang dasar-dasar aljabar linear untuk pemula.</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="lg:col-span-4 space-y-6">
                    ...
                    <div class="bg-white rounded-2xl shadow-lg shadow-slate-200/50 border border-slate-100 p-6 top-24">
                        <div class="flex justify-between items-end mb-4">
                            <div>
                                <h3 class="text-sm font-semibold text-slate-500 uppercase tracking-wider">Kelengkapan
                                </h3>
                            </div>
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                <!-- Tombol Kembali -->
                                <a href="materi-step-1.html" type="button"
                                ...
                                <!-- Tombol Lanjut -->
                                <a href="materi-step-3.html" type="button"
